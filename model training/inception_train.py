...
train_data=np.load('COVID_Xray/Feature Extraction/InceptionV3/InceptionV3_train_features.npy')
validation_data=np.load('COVID_Xray/Feature Extraction/InceptionV3/InceptionV3_val_features.npy')
test_data=np.load('COVID_Xray/Feature Extraction/InceptionV3/InceptionV3_test_features.npy')
