...
train_data=np.load('COVID_Xray/Feature Extraction/Xception/Xception_train_features.npy')
validation_data=np.load('COVID_Xray/Feature Extraction/Xception/Xception_val_features.npy')
test_data=np.load('COVID_Xray/Feature Extraction/Xception/Xception_test_features.npy')
